...
Punctuation mark plays an important role in segmentation boundary detection, and large numbers of errors were encountered by the false positive of boundary identification. For example, ``xxxxx xxxxxx'' was segmented after the second sentence where a punctuation mark was encountered. Similarly, additional information is the common reason for the classified original segment into multiple segments. For instance, ``xxxx xxxx xxxx'' was segmented after second sentence where third sentence supports the MI code confirmed by first two sentences. 
