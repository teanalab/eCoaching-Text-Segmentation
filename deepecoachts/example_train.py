...
embpath='/media/mehedi/FEJ/Embeddings-deepecoach/ptbr/word2vec/pt_word2vec_sg_600.emb'
...
options['emb_file'] = embpath			# e.g. Embeddings-deepecoach/ptbr/word2vec/pt_word2vec_sg_600.emb
