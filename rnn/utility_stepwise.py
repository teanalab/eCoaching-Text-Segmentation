...
def get_encoded_sequence(data, vocabulary_obj, max_len):
    x, y = [], []
    ...
    data_x = numpy.reshape(data_x, (data_x.shape[0], 1, max_len, 1))
    # normalize
    data_x = data_x / vocabulary_obj.size()
    data_y = numpy.array(pad_sequences(y, max_len))
    data_y = numpy.reshape(data_y, (data_y.shape[0], 1, max_len, 1))
