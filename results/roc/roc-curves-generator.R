...
legend(0.75,0.36, c("KNN", "SVM", "NB"), 
       lty=c(1,1,1), col=c('red', 'blue', 'green'), cex=1, lwd=1)

# print AUC values
x1 <- read.csv("/home/mehedi/teana/projects/eCoaching-Text-Segmentation/results/roc/True/auc_RNN-LSTMTrue-ROC.csv")
x2 <- read.csv("/home/mehedi/teana/projects/eCoaching-Text-Segmentation/results/roc/True/auc_RNN-GRUTrue-ROC.csv")
...
lines(0:1, 0:1, col='black', lty=5, lwd=1)
legend(0.73,0.53, c("KNN", "SVM", "NB", "LSTM", "GRU"), 
