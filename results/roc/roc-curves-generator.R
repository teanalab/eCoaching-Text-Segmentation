...
lines(r2$fpr, r2$tpr, col='blue', lty=1, lwd=1)
lines(r3$fpr, r3$tpr, col='green', lty=1, lwd=1)
lines(1-roc_obj_lstm$specificities, roc_obj_lstm$sensitivities, col='purple', lty=1, lwd=1)
lines(1-roc_obj_gru$specificities, roc_obj_gru$sensitivities, col='pink', lty=1, lwd=1)
lines(0:1, 0:1, col='black', lty=5, lwd=1)
legend(0.73,0.47, c("KNN", "SVM", "NB", "LSTM", "GRU"), 
       lty=c(1,1,1,1,1), col=c('red', 'blue', 'green', 'purple', 'pink'), cex=1, lwd=1)
